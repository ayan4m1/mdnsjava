...
public final class Constants {
  ...
  /**
   * The domain name used by DNS-Based Service Discovery (DNS-SD) [RFC 6763] to list default browse
   * domains
   */
  ...
  /**
   * The domain name used by DNS-Based Service Discovery (DNS-SD) [RFC 6763] to list legacy browse
   * domains
   */
  public static final String LEGACY_BROWSE_DOMAIN_NAME = "lb._dns-sd._udp";

  /**
   * The domain name used by DNS-Based Service Discovery (DNS-SD) [RFC 6763] to list default
   * registration domains
   */
  public static final String DEFAULT_REGISTRATION_DOMAIN_NAME = "dr._dns-sd._udp";

  /**
   * The domain name used by DNS-Based Service Discovery (DNS-SD) [RFC 6763] to list registration
   * domains
   */
  public static final String REGISTRATION_DOMAIN_NAME = "r._dns-sd._udp";

  /**
   * The domain names used by DNS-Based Service Discovery (DNS-SD) [RFC 6763] to iterate registered
   * service types
   */
